        ...
        <div className="flex-2 flex flex-col justify-center md:w-[70%] md:mt-[-40px]">
          ...
          <div className="flex sm:justify-start md:flex-row sm:flex-row-reverse mr-4 items-center gap-5">
            ...
            <div className="flex gap-4">
              ...
              ></i>
              <i class="fa-brands fa-linkedin fa-beat fa-xl text-[#ff4848]"></i>
              <i class="fa-brands fa-twitter fa-beat fa-xl text-[#ff4848]"></i>
              <i class="fa-brands fa-square-instagram fa-beat fa-xl text-[#ff4848]"></i>
            </div>
          </div>
        </div>
